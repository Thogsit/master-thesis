...
public class SecretController(
    ...
    public async Task<IActionResult> ToggleAgency(
        ...
        SealedFgaGuard.RequireCheck(newId, SecretEntityIdAttributes.can_view);
        SealedFgaGuard.RequireCheck(secret, SecretEntityIdAttributes.can_view);
        SealedFgaGuard.RequireCheck(secretId, SecretEntityIdAttributes.can_view);
