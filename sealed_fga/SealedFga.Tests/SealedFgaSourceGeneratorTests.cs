...
using SealedFga.Tests.Utils;
using Xunit;

namespace SealedFga.Tests;

public class SealedFgaSourceGeneratorTests
{
...
Customer";
    ...
    public void GenerateClassesBasedOnDDDRegistry()
    {
        ...
        var generator = new SealedFgaSourceGenerator();
        ...
        var compilation = CSharpCompilation.Create(nameof(SealedFgaSourceGeneratorTests));
